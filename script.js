...
function filterCourses(category) {
  ...
  courses.forEach(course => {
    // If category is 'all' or the course has the matching category, display it
...
function goFurther(){
  if (document.getElementById("chkAgree").checked == true) {
    document.getElementById('btnSubmit').style = 'background: linear-gradient(to right, #292C6A, #158B44);';
  }
  else{
